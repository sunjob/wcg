...
<body>
	...
	<form class="form-horizontal" id="lbsForm" action="wvoteAction!add"  enctype="multipart/form-data" onsubmit="return checkform();" method="post">	<div class="control-group">
	    	<label class="control-label" for="keyword">微投票名称</label>
	    	<div class="controls">
	    	<input type="text"    name="wvote.name" id="name" class="span4"/>		    	<span class="maroon">*</span>
	  	...
	  	<div class="control-group">
	    	...
	    	<div class="controls">
	    	<input type="text"    name="wvote.keywordname" id="keywordname" class="span4"/>		    	<span class="maroon">*</span>
		...
		<div class="control-group">
	    	...
	    	<div class="controls">
	  		...
	  		<input type="date"  name="wvote.starttime"    id="starttime" class="span4"  />	 
	    	   	</div>
	  	</div>
	  	...
	  	<div class="control-group">
	    	...
	    	<div class="controls">
	    	<input type="date"  name="wvote.endtime"    id="endtime" class="span4"   />	 
	    	   	</div>
	  	</div>
		<div class="control-group">
		...
		<img alt="暂无图片"  id="myimage" width="300px" height="256px"/>
	  	...
	  	<div class="control-group">
			...
			<div class="controls">
			<textarea name="wvote.content"   id="content" class="span5" style="height:90px;width:520px;"></textarea>				<span class="maroon">*</span><br><span class="help-inline">最多为1000个字符。</span>
			</div>
		</div>
	  	...
	  	<div class="control-group">
	    	...
	    	<div class="controls">
	    	<input type="text"    name="option1" id="option1" class="span4"/>		    	<span class="maroon">*</span>
		    	<span class="help-inline">最多只能输入30个字符。</span>
	    	</div>
	  	</div>
	  	<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					...
					<br/>
					<img alt="暂无图片"  id="myimage1" width="200px" height="160px"/>
				<script type="text/javascript">
							function change1() {
	  	...
	  	<div class="control-group">
	    	...
	    	<div class="controls">
	    	<input type="text"     name="option2" id="option2" class="span4"/>		    	<span class="maroon">*</span>
		    	<span class="help-inline">最多只能输入30个字符。</span>
	    	</div>
	  	</div>
		<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					...
					<br/>
					<img alt="暂无图片"  id="myimage2" width="200px" height="160px"/>
				<script type="text/javascript">
							function change2() {
	    	...
	    	<div class="controls">
	    	<input type="text"     name="option3" id="option3" class="span4"/>		    	<span class="maroon">*</span>
		    	<span class="help-inline">最多只能输入30个字符。</span>
	    	</div>
	  	</div>
		<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					...
					<br/>
					<img alt="暂无图片"  id="myimage3" width="200px" height="160px"/>
				<script type="text/javascript">
							function change3() {
	    	...
	    	<div class="controls">
	    	<input type="text"     name="option4" id="option4" class="span4"/>		    	<span class="maroon">*</span>
		    	<span class="help-inline">最多只能输入30个字符。</span>
	    	</div>
	  	</div>
		<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					...
					<br/>
					<img alt="暂无图片"  id="myimage4" width="200px" height="160px"/>
				<script type="text/javascript">
							function change4() {
	    	...
	    	<div class="controls">
	    	<input type="text"     name="option5" id="option5" class="span4"/>		    	<span class="maroon">*</span>
		    	<span class="help-inline">最多只能输入30个字符。</span>
	    	</div>
	  	</div>
		<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					...
					<br/>
					<img alt="暂无图片"  id="myimage5" width="200px" height="160px"/>
				<script type="text/javascript">
							function change5() {
	    	...
	    	<div class="controls">
	    	<input type="text"     name="option6" id="option6" class="span4"/>		    	<span class="maroon">*</span>
		    	<span class="help-inline">最多只能输入30个字符。</span>
	    	</div>
	  	</div>
		<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					...
					<br/>
					<img alt="暂无图片"  id="myimage6" width="200px" height="160px"/>
				<script type="text/javascript">
							function change6() {
	    	...
	    	<div class="controls">
	    	<input type="text"     name="option7" id="option7" class="span4"/>		    	<span class="maroon">*</span>
		    	<span class="help-inline">最多只能输入30个字符。</span>
	    	</div>
	  	</div>
		<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					...
					<br/>
					<img alt="暂无图片"  id="myimage7" width="200px" height="160px"/>
				<script type="text/javascript">
							function change7() {
	    	...
	    	<div class="controls">
	    	<input type="text"     name="option8" id="option8" class="span4"/>		    	<span class="maroon">*</span>
		    	<span class="help-inline">最多只能输入30个字符。</span>
	    	</div>
	  	</div>
		<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					...
					<br/>
					<img alt="暂无图片"  id="myimage8" width="200px" height="160px"/>
				<script type="text/javascript">
							function change8() {
	    	...
	    	<div class="controls">
	    	<input type="text"     name="option9" id="option9" class="span4"/>		    	<span class="maroon">*</span>
		    	<span class="help-inline">最多只能输入30个字符。</span>
	    	</div>
	  	</div>
		<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					...
					<br/>
					<img alt="暂无图片"  id="myimage9" width="200px" height="160px"/>
				<script type="text/javascript">
							function change9() {
	    	...
	    	<div class="controls">
	    	<input type="text"   name="option10" id="option10" class="span4"/>		    	<span class="maroon">*</span>
		    	<span class="help-inline">最多只能输入30个字符。</span>
	    	</div>
	  	</div>
		<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					...
					<br/>
					<img alt="暂无图片"  id="myimage10" width="200px" height="160px"/>
				<script type="text/javascript">
							function change10() {
