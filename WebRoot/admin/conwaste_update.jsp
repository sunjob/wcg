...
<body>
	...
	<form class="form-horizontal" id="lbsForm" action="conwasteAction!update" method="post">
		<s:hidden name="conwaste.id"></s:hidden>
        <s:hidden name="conwaste.status"></s:hidden>
        <s:hidden name="conwaste.forquery"></s:hidden>
